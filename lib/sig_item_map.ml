...
type t = {
  values_map : (int * value_description) String_map.t;
  modules_map : (int * module_declaration) String_map.t;
  modtypes_map : (int * modtype_declaration) String_map.t;
  types_map : (int * type_declaration * Ident.t) String_map.t;
  class_map : (int * class_declaration) String_map.t;
  class_type_map : (int * class_type_declaration) String_map.t;
}
